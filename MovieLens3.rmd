...
---
__Movielens Project__  
__Larisa Doherty__
__Steps:__  

* Clean the data
  + Split genres into distinct genre for train and test set
  + Extract Year from title for train and test set
  + Convert timestamp to datetime
  + Remove timestamp column
* Analyze the data and determine the columns that predict the answer
  + Get unique ratings, users, movies, genres, release year
  + Plot distribution of ratings, movies, users, and genres
* Create model
  + Define rmse function
* Test model on training set named 'edx'
* Run model on test set named 'validation'
* Evaluate the model’s effectiveness on 'validation' set, function named rmse
* Store model results in table named 'results'
